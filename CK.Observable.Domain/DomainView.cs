...
namespace CK.Observable
{
    ...
    {
        readonly IDestroyableObject _o;
        readonly ObservableDomain _d;

        internal DomainView( IDestroyableObject o, ObservableDomain d )
        {
            _o = o;
            _d = d;
        }
        ...
        /// <summary>
        /// Ensures that required sidekicks are instantiated and that any required <see cref="ObservableDomainSidekick.RegisterClientObject(IActivityMonitor, IDestroyableObject)"/>
        /// have been called.
