...
namespace CK.Observable
{
    ...
    /// Object that supports this interface are submitted to the given sidekick (see <see cref="ObservableDomainSidekick.RegisterClientObject(Core.IActivityMonitor, IDestroyable)"/>)
