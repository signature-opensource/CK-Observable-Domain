...
namespace CK.Observable.League
{
        ...
        where T2 : ObservableRootObject
    {
        ...
        /// </returns>
        Task<TransactionResult> ModifyAsync( IActivityMonitor monitor, Action<IActivityMonitor, IObservableDomain<T1,T2>> actions, int millisecondsTimeout = -1, bool parallelDomainPostActions = true );
        ...
        Task ModifyThrowAsync( IActivityMonitor monitor, Action<IActivityMonitor, IObservableDomain<T1, T2>> actions, int millisecondsTimeout = -1, bool parallelDomainPostActions = true );
        ...
        Task<TResult> ModifyThrowAsync<TResult>( IActivityMonitor monitor, Func<IActivityMonitor, IObservableDomain<T1, T2>, TResult> actions, int millisecondsTimeout = -1, bool parallelDomainPostActions = true );
        ...
        /// </returns>
        Task<(Exception? OnStartTransactionError, TransactionResult Transaction)> ModifyNoThrowAsync( IActivityMonitor monitor, Action<IActivityMonitor, IObservableDomain<T1, T2>> actions, int millisecondsTimeout = -1, bool parallelDomainPostActions = true );
