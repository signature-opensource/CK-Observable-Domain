...
namespace CK.Observable.League
{
        ...
        where T4 : ObservableRootObject
    {
        ...
        /// </returns>
        Task<(Exception? OnStartTransactionError, TransactionResult Transaction, TransactionResult.AsyncResult PostActionsResult)> ModifyNoThrowAsync( IActivityMonitor monitor, Action<IActivityMonitor, IObservableDomain<T1, T2, T3, T4>> actions, int millisecondsTimeout = -1 );
