...
namespace CK.Observable.League
{
    ...
    {
        /// <summary>
        /// This is the primary, first client. It handles the transaction snapshot.
        /// </summary>
        class StreamStoreClient : MemoryTransactionProviderClient
        {
            ...
            public StreamStoreClient( string domainName, IStreamStore store )
                : base( new TransactionEventCollectorClient() )
            {
            ...
            /// <summary>
            /// Initializes the domain from the store or initiaizes the store from the domain.
            /// </summary>
