...
namespace CK.Observable
{
    ...
    public interface IStreamStore
    {
        ...
        Task<DateTime> CreateAsync( string fullName, Func<Stream,Task> writer );
        ...
        Task<DateTime> UpdateAsync( string fullName, Func<Stream,Task> writeContent, bool allowCreate = false, DateTime checkLastWriteTimeUtc = default );
