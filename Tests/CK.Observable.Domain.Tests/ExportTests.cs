...
namespace CK.Observable.Domain.Tests
{
    ...
    public class ExportTests
    {
        ...
        public void exporting_and_altering_simple()
        {
            ...
            var d = new ObservableDomain(TestHelper.Monitor, "TEST", eventCollector);
        ...
        public void exporting_and_altering_ApplicationState()
        {
            ...
            var d = new ObservableDomain<RootSample.ApplicationState>( TestHelper.Monitor, "TEST", eventCollector);
            d.Modify( TestHelper.Monitor, () =>
            {
