...
describe('ObservableDomain eyeball tests - ', function () {
    it('Test 1', function () {
        ...
        console.log("intial Simple graph:", o.allObjects);
        o.applyEvent(JSON.parse(t2));
        console.log("Simple graph after t2:", o.allObjects);
        o.applyEvent(JSON.parse(t3));
        console.log("Simple graph after t3:", o.allObjects);
        o.applyEvent(JSON.parse(t4));
        console.log("Simple graph after t4:", o.allObjects);
        o.applyEvent(JSON.parse(t5));
        console.log("Simple graph after t5:", o.allObjects);
        o.applyEvent(JSON.parse(t6));
        console.log("Simple graph after t6:", o.allObjects);
        o.applyEvent(JSON.parse(t7));
        console.log("Simple graph after t7:", o.allObjects);
        o.applyEvent(JSON.parse(t8));
        console.log("Simple graph after t8:", o.allObjects);

    });

    it('Test 2 (sample)', function () {
        ...
        var o = new ObservableDomain(initial);
        console.log("intial Sample graph:", o.allObjects);
        o.applyEvent(JSON.parse(t1));
        o.applyEvent(JSON.parse(t2));
        console.log("Sample graph after t1 and t2:", o.allObjects);
        o.applyEvent(JSON.parse(t3));
        console.log("Sample graph after t3:", o.allObjects);
        o.applyEvent(JSON.parse(t4));
        console.log("Sample graph after t4:", o.allObjects);
